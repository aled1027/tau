---
name: lit-component
description: Create well-structured Lit web components with TypeScript. Use when asked to build UI components, pages, or web component features.
---
# Lit Web Component Creation
